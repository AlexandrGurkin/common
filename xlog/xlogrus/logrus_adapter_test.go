...
func TestNewXLogrusSuccess(t *testing.T) {
	...
	expectMsg := []byte("{\"level\":\"trace\",\"msg\":\"ep\",\"time\":\"")
...
func Test_xrus_WithXField(t *testing.T) {
	...
	expectMsg1 := []byte("{\"level\":\"trace\",\"msg\":\"ep\",\"time\":\"")
	expectMsg2 := []byte("{\"key\":\"value\",\"level\":\"trace\",\"msg\":\"ep\",\"time\":\"")
	mockWriter := mocks.NewMockWriter(ctrl)
...
func Test_xrus_WithXFields(t *testing.T) {
	...
	expectMsg1 := []byte("{\"level\":\"trace\",\"msg\":\"ep\",\"time\":\"")
	expectMsg2 := []byte("{\"key\":\"value\",\"level\":\"trace\",\"lol\":\"kek\",\"msg\":\"ep\",\"time\":\"")
	mockWriter := mocks.NewMockWriter(ctrl)
